...
register(
    id="VSSMA-v0", entry_point="rsoccer_gym.vss.env_ma:VSSMAEnv", max_episode_steps=1200
)
...
register(
    id="SSLGoToBallShoot-v0",
    entry_point="rsoccer_gym.ssl.ssl_go_to_ball_shoot:SSLGoToBallShootEnv",
    kwargs={"field_type": 2, "random_init": True, "enter_goal_area": False},
